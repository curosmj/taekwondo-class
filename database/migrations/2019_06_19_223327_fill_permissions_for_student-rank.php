...
class FillPermissionsForStudentRank extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStudentRank constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.student-rank',
            'admin.student-rank.index',
            'admin.student-rank.create',
            'admin.student-rank.show',
            'admin.student-rank.edit',
            'admin.student-rank.delete',
        ]);
