                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'cost_price'">{{ trans('admin.product.columns.cost_price') }}</th>
                                    <th is='sortable' :column="'selling_price'">{{ trans('admin.product.columns.selling_price') }}</th>
