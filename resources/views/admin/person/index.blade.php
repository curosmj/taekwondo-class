                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'person_fname'">{{ trans('admin.person.columns.person_fname') }}</th>
                                    <th is='sortable' :column="'person_lname'">{{ trans('admin.person.columns.person_lname') }}</th>
