                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'service_name'">{{ trans('admin.service.columns.service_name') }}</th>
                                    <th is='sortable' :column="'service_description'">{{ trans('admin.service.columns.service_description') }}</th>
                                    <th is='sortable' :column="'service_selling_price'">{{ trans('admin.service.columns.service_selling_price') }}</th>
                                    <th is='sortable' :column="'service_num_days'">{{ trans('admin.service.columns.service_num_days') }}</th>
                            ...
                            <tbody>
                                <tr v-for="(item, index) in collection">
                                    ...
                                    <td>@{{ item.service_selling_price }}</td>
                                    <td>@{{ item.service_num_days }}</td>
